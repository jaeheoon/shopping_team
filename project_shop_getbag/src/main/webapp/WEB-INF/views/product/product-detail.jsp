  ...
  <div class="productDetail">
    <div class="container">
      <div class="row">
        ...
        <h5 class="mb-4 ms-3">홈페이지 > 상품 > <%= product.getCategory() %></h5>
        ...
        <div class="col-6" style="margin-top: 12%;">
          <div style="margin-left: 15%;">
            ...
            <form name="addForm" action="/getbag/basket-action?id=<%= product.getPid() %>" method="post">
            	<a href="#"><button class="btn btn-simple mb-3" onclick="addToBasket()">장바구니에 추가</button></a></form>
            <form name="addForm" action="/getbag/wish-action?id=<%= product.getPid() %>" method="post">
            	<a href="#"><button class="btn btn-white mb-3" onclick="addToWish()">위시리스트에 추가</button></a>
            </form>
          </div>
        </div>
      </div>
